//! Styled sidebar matching shadcn/ui.
//!
//! A complex composite component that uses Sheet, Tooltip, Button, and Separator
//! from the styled layer. Includes mobile responsiveness via JS eval and
//! keyboard shortcut (Ctrl/Cmd+B) to toggle.

use crate::button::{Button, ButtonVariant};
use crate::separator::Separator;
use crate::sheet::{Sheet, SheetContent, SheetDescription, SheetHeader, SheetSide, SheetTitle};
